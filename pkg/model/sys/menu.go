...
type Menu struct {
	...
	MenuType uint8  `gorm:"column:menu_type;type:tinyint(1);not null;" json:"menu_type" form:"menu_type"`    // 菜单类型 1 模块(无操作),2 菜单,3 操作
	...
	Method   string `gorm:"column:method;size:32;not null;" json:"method" form:"method"`                     // 操作类型 NONE?/GET/PUT/POST/DELETE
}
