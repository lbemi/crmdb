 ...
 * @schema Pipeline
 */
export declare class Pipeline extends ApiObject {
    /**
     ...
     */
    static manifest(props?: PipelineProps): any;
 ...
 * @schema PipelineRun
 */
export declare class PipelineRun extends ApiObject {
    /**
     ...
     * @param props initialization props
     */
    constructor(scope: Construct, id: string, props?: PipelineRunProps);
    /**
     * Renders the object to Kubernetes JSON.
     */
    toJson(): any;
