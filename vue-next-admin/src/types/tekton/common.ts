...
import type { Configuration } from './test/configuration';
import type { RequestArgs } from './test/base';
import type { AxiosInstance, AxiosResponse } from 'axios';
import { RequiredError } from './test/base';
...
export const serializeDataIfNeeded = function (value: any, requestOptions: any, configuration?: Configuration) {
	...
	return needsSerialization ? JSON.stringify(value !== undefined ? convertMapsAndSetsToPlain(value) : {}) : value || '';
};
