...
import { Event, Pod, Service, Endpoints } from '@/types/kubernetes-types/core/v1';
import { DaemonSet, Deployment, ReplicaSet, ReplicaSetCondition, StatefulSet } from '@/types/kubernetes-types/apps/v1';
