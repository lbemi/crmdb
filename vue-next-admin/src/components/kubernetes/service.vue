		...
		<el-form ref="ruleFormRef" :model="data.service" label-width="120px" class="demo-ruleForm" status-icon>
			<el-card class="card">
				<el-form-item label="类型" prop="type">
					<el-select v-model="data.service.spec!.type" size="small">
				...
				<el-form-item label="服务名称" prop="name">
					<el-input v-model="data.service.metadata!.name" style="width: 190px" size="small" />
...
import { DaemonSet, Deployment, StatefulSet } from '@/types/kubernetes-types/apps/v1';
