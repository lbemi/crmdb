	...
	<div>
		<el-form-item label-width="100px" style="margin-bottom: 0">
			...
			<el-button
				...
				>隐藏</el-button
			>
			<el-button v-else type="info" text :icon="CaretBottom" @click="data.show = !data.show" size="small" style="margin-left: 20px">展开</el-button>
		</el-form-item>
...
import { ConfigMap, PersistentVolumeClaim, Secret, Volume, VolumeMount, KeyToPath } from 'kubernetes-models/v1';
...
const pvcApi = usePersistentVolumeClaimApi();
...
// 从接口获取pvc数据
const getPvc = async () => {
	await pvcApi.listPersistentVolumeClaim(k8sStore.state.creatDeployment.namespace, { cloud: k8sStore.state.activeCluster }).then((res) => {
