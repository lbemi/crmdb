...
export default {
	router: {
		...
		k8sDeployment: '无状态',
		k8sDeploymentDetail: '无状态详情',
		deploymentCreate: '创建无状态',
		k8sDaemonset: '守护进程',
		k8sDaemonsetDetail: '守护进程详情',
		daemonsetCreate: '创建守护进程',
		k8sStatefulSet: '有状态',
		k8sStatefulSetDetail: '有状态详情',
		statefulSetCreate: '创建有状态',
		k8sJob: '任务',
		k8sJobDetail: '任务详情',
		jobCreate: '创建任务',
		k8sCronJob: '定时任务',
		k8sCronJobDetail: '定时任务详情',
		cronJobCreate: '创建定时任务',
		podDetail: '容器组详情',
		monitor: '监控大盘',
		monitorHost: '主机监控',
		monitorSSL: 'SSL证书监控',
