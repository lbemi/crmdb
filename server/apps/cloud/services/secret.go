...
func NewSecret(client *cache.ClientConfig, ns string) *Secret {
	return &Secret{client: client, ns: ns}
}

func (s *Secret) List(ctx context.Context, query *entity.PageParam, name string, label string) *entity.PageResult {
