...
func NewIngresses(client *cache.ClientConfig, namespace string) *ingresses {
	return &ingresses{client: client, namespace: namespace}
}

func (i *ingresses) List(ctx context.Context, query *entity.PageParam, name string, label string) *entity.PageResult {
