...
func NewCronJob(client *cache.ClientConfig, namespace string) *cronJob {
	return &cronJob{cli: client, ns: namespace}
}

func (d *cronJob) List(ctx context.Context, query *entity.PageParam, name string, label string) *entity.PageResult {
